    ...
    <div class="mx-auto max-w-3xl px-6 py-10">
        <div class="space-y-6 rounded-3xl bg-white p-6 shadow-lg ring-1 ring-slate-200 sm:p-8">
            <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                <div>
                    <h1 class="text-2xl font-semibold text-slate-900">Edit Data Masyarakat</h1>
                    <p class="mt-1 text-sm text-slate-600">Perbarui informasi warga yang tersimpan.</p>
                </div>
            ...
            <form action="{{ route('Masyarakat.update', $Masyarakat->id) }}" method="POST" class="space-y-6">
                @csrf
                @method('PUT')

                <div>
                    <label for="nomor_kk" class="block text-sm font-medium text-slate-700">Nomor KK</label>
                    <input type="text" name="nomor_kk" id="nomor_kk" value="{{ old('nomor_kk', $Masyarakat->nomor_kk) }}" class="mt-2 block w-full rounded-3xl border border-slate-200 bg-white py-3 px-4 text-sm text-slate-900 shadow-sm focus:border-sky-500 focus:outline-none focus:ring-4 focus:ring-sky-100">
                ...
                <div>
                    ...
                    <input type="text" name="nomor_ktp" id="nomor_ktp" value="{{ old('nomor_ktp', $Masyarakat->nomor_ktp) }}" class="mt-2 block w-full rounded-3xl border border-slate-200 bg-white py-3 px-4 text-sm text-slate-900 shadow-sm focus:border-sky-500 focus:outline-none focus:ring-4 focus:ring-sky-100">
                ...
                <div>
                    ...
                    <input type="text" name="nama" id="nama" value="{{ old('nama', $Masyarakat->nama) }}" class="mt-2 block w-full rounded-3xl border border-slate-200 bg-white py-3 px-4 text-sm text-slate-900 shadow-sm focus:border-sky-500 focus:outline-none focus:ring-4 focus:ring-sky-100">
                ...
                <div>
                    ...
                    <textarea name="alamat" id="alamat" rows="4" class="mt-2 block w-full rounded-3xl border border-slate-200 bg-white py-3 px-4 text-sm text-slate-900 shadow-sm focus:border-sky-500 focus:outline-none focus:ring-4 focus:ring-sky-100">{{ old('alamat', $Masyarakat->alamat) }}</textarea>
